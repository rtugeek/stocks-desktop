...
const {widgetParams, save, widgetTheme} = useWidget()
  ...
  >
    <template #custom>
      <el-form label-width="70">
        ...
        <WidgetPixelSliderField v-model="widgetTheme.fontSize" title="字体大小" :min="12" :max="30"/>
        <el-form-item label="标题显示">
          <el-radio-group v-model="stockTitle">
            <el-radio :value="0">股票代码</el-radio>
            <el-radio :value="1">股票名</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="涨跌颜色" >
          <el-radio-group v-model="stockColor">
            <el-radio :value="0"><span class="color-red">红涨</span> <span class="color-green">绿跌</span></el-radio>
            <el-radio :value="1"><span class="color-green">红跌</span> <span class="color-red">绿涨</span></el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
    </template>
